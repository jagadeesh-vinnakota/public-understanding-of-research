...
def cosine_similarity(data_given,index_given,dictionary_given,lda_given,file_local,primary_key_local):
    data_give = [dd.lower() for dd in data_given.split()]
    data_give = [stemmer.stem(plural) for plural in data_give]
    vec_bow = dictionary_given.doc2bow(data_give)
...
def best_function(tweets_list,index_function,dictionary_function,lda_function,file_local,primary_key_local):
    ...
    for data_g in tweets_list:
        ...
        per = cosine_similarity(data_g,index_function,dictionary_function,lda_function,file_local,primary_key_local)
...
if __name__=="__main__":
    with open('D:machinelearningproject/exceptionsfile.log','w') as filp:
        ...
        for i in range(0,100):
            ...
            for data in d:
                ...
                texts = [stemmer.stem(plural) for plural in texts]
                supertext_main.append(texts)
                texts1 = []
                for word in data['title'][0].split():
                    texts1.append(word.lower())
                texts1 = [stemmer.stem(plural) for plural in texts1]
                ...
                if 'twitter' in data:
                    percen = best_function(data['twitter'],index_main,dictionary_main,lda_main,filp,data['primary_key'])
                ...
                if 'facebook' in data:
                    percen = best_function(data['facebook'],index_main,dictionary_main,lda_main,filp,data['primary_key'])
                ...
                if 'blogs' in data:
                    percen = best_function(data['blogs'],index_main,dictionary_main,lda_main,filp,data['primary_key'])
                ...
                if 'googleplus' in data:
                    percen = best_function(data['googleplus'],index_main,dictionary_main,lda_main,filp,data['primary_key'])
                ...
                if 'wikipedia' in data:
                    percen = best_function(data['wikipedia'],index_main,dictionary_main,lda_main,filp,data['primary_key'])
                ...
                if 'news' in data:
                    percen = best_function(data['news'],index_main,dictionary_main,lda_main,filp,data['primary_key'])
